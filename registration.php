...
<div class = "input-group">
  <input  class="input--style-3" type="text"  placeholder="username" id = "username" name="username"></input><br><br>
</div>

<div class = "input-group">
  <input  class="input--style-3" type="text"  placeholder="name" id = "name" name="name"></input><br><br>
</div>

<div class = "input-group">
  <input  class="input--style-3" type="surname"  placeholder="surname" id = "surname" name="surname"></input><br><br>
</div>

 <div class="input-group">
                            <input class="input--style-3 js-datepicker" id = "birthdate" type="text" placeholder="birthdate" name="birthdate">
                            <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i>
</div>

         <div class = "input-group" name="gender">
	     <div class="rs-select2 js-select-simple select--no-search" id = "gender" name="gender">
                                <select name="gender">
